...
#define CAN_RST		7//PA7
#define CAN_WAITING	!(PORTC_IN & (1 << CAN_INT))
...
void transmit_CAN(uint16_t standard_identifier, uint8_t remote_transmission_request,
uint8_t data_length, uint8_t data[]);
void transmit_CAN_(uint8_t standard_identifier, uint8_t remote_transmission_request,
uint8_t data_length, uint8_t data[]);
